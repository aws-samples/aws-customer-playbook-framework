...
- Passen Sie diese Lambda-Funktion mit den Ports und IP-Bereichen an, die für Ihre Geschäftsanforderungen erforderlich sind.
...
1. Wählen Sie unter IAM-Ressourcen die Option Benutzer aus
