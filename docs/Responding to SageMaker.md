...
![SageMaker Domain with associated VPC, execution role, apps, etc](/sagemaker_images/sagemaker-04.png)
...
![Create endpoint example](/sagemaker_images/sagemaker-05.png)
