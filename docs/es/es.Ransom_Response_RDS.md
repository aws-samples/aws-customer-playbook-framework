...
6. [**DETECCIÓN Y ANALÍSIS**] Utilice VPCFlowlogs para identificar el acceso inadecuado a la base de datos desde direcciones IP externas
...
* **Fuentes de registro**: Archivos de registro de bases de datos RDS, registros de acceso de S3, CloudTrail, CloudWatch, AWS Config
