...
4. [**DETECCIÓN Y ANALÍSIS**] Procedimientos de uso que se encuentran en el equipo de inteligencia de amenazas de Microsoft 365 Defender
...
* Supervisar para borrar los registros de sucesos, especialmente el registro de sucesos de seguridad y los registros operativos de PowerShell. Microsoft Defender ATP genera la alerta «El registro de eventos se ha borrado» y Windows genera un ID de evento 1102 cuando esto ocurre
...
* Utilice el Firewall de Windows Defender y el cortafuegos de red para evitar la comunicación RPC y SMB entre los endpoints siempre que sea posible. Esto limita el movimiento lateral, así como otras actividades de ataque.
...
* comprobación de plataforma de instancias gestionadas ec2
...
### El equipo de inteligencia de amenazas de Microsoft 365 Defender
